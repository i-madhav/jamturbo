          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 cursor-pointer">
              ...
              <div className="bg-white/5 rounded-2xl p-8 backdrop-blur-sm hover:bg-white/10 transition">
                ...
                <p className="text-gray-400">
                  Create invitation-only sessions or join public rooms to meet
                  new music lovers.
                </p>
              </div>
              ...
              <div className="bg-white/5 rounded-2xl p-8 backdrop-blur-sm hover:bg-white/10 transition">
                ...
                <p className="text-gray-400">
                  Allow everyone in the room to contribute their favorite
                  tracks, creating a collaborative playlist for all to enjoy in
                  real-time.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="relative group border rounded-lg">
                ...
                <div className="relative bg-black/40 backdrop-blur-xl border border-primary-500/20 rounded-2xl p-8">
                  ...
                  <Link href={"/sign-in"} className="w-full block text-center py-3 bg-primary-600 hover:bg-primary-700 text-white rounded-xl transition">
                    Subscribe Now
                  </Link>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="relative group">
                ...
                <div className="relative bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl p-8">
                  ...
                  <p className="text-gray-300">
                    ...
                    The real-time interaction and synchronized playback make
                    every listening session special."
                  </p>
              ...
              <div className="relative group">
                ...
                <div className="relative bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl p-8">
                  ...
                  <p className="text-gray-300">
                    "Hosting virtual music events has never been easier. The
                    sound quality is exceptional, and the community features are
                    top-notch."
                  </p>
              ...
              <div className="relative group">
                ...
                <div className="relative bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl p-8">
                  ...
                  <p className="text-gray-300">
                    "Perfect for my online music classNamees! My students love
                    the interactive nature of the platform and how we can all
                    listen together."
                  </p>
            ...
            <div className="relative z-10">
              <div className="max-w-2xl text-center mx-auto">
                ...
                <p className="text-lg text-neutral-400 mb-8">
                  Join thousands of music lovers sharing their favorite tracks
                  in real-time. Create your first room, invite friends, and
